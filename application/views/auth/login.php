        ...
        <div class="col-xl-10 col-lg-6">
            ...
            <div class=" card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-5 d-none d-lg-block"><img src="assets/img/login/bc-bgr.png" alt=""></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-5 font-weight-bold">WELCOME TO SI ANGKLUNG</h1>
                                </div>
